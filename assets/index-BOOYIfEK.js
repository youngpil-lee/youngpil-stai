...
`+r.getProgramInfoLog(s));n=t.s=s,r.useProgram(n),i=r.getUniformLocation(n,"sampler0"),t.l={O:r.getAttribLocation(n,"aVertex"),N:r.getAttribLocation(n,"aTex"),ya:i},t.v=r.createBuffer(),r.bindBuffer(r.ARRAY_BUFFER,t.v),r.enableVertexAttribArray(t.l.O),r.vertexAttribPointer(t.l.O,2,r.FLOAT,!1,0,0),r.bufferData(r.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),r.STATIC_DRAW),r.bindBuffer(r.ARRAY_BUFFER,null),t.u=r.createBuffer(),r.bindBuffer(r.ARRAY_BUFFER,t.u),r.enableVertexAttribArray(t.l.N),r.vertexAttribPointer(t.l.N,2,r.FLOAT,!1,0,0),r.bufferData(r.ARRAY_BUFFER,new Float32Array([0,1,0,0,1,0,1,1]),r.STATIC_DRAW),r.bindBuffer(r.ARRAY_BUFFER,null),r.uniform1i(i,0)}n=t.l,r.useProgram(t.s),r.canvas.width=e.width,r.canvas.height=e.height,r.viewport(0,0,e.width,e.height),r.activeTexture(r.TEXTURE0),t.i.bindTexture2d(e.glName),r.enableVertexAttribArray(n.O),r.bindBuffer(r.ARRAY_BUFFER,t.v),r.vertexAttribPointer(n.O,2,r.FLOAT,!1,0,0),r.enableVertexAttribArray(n.N),r.bindBuffer(r.ARRAY_BUFFER,t.u),r.vertexAttribPointer(n.N,2,r.FLOAT,!1,0,0),r.bindFramebuffer(r.DRAW_FRAMEBUFFER?r.DRAW_FRAMEBUFFER:r.FRAMEBUFFER,null),r.clearColor(0,0,0,0),r.clear(r.COLOR_BUFFER_BIT),r.colorMask(!0,!0,!0,!0),r.drawArrays(r.TRIANGLE_FAN,0,4),r.disableVertexAttribArray(n.O),r.disableVertexAttribArray(n.N),r.bindBuffer(r.ARRAY_BUFFER,null),t.i.bindTexture2d(0)}function tn(t){this.h=t}var en=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,2,1,0,10,9,1,7,0,65,0,253,15,26,11]);function rn(t,e){return e+t}function yr(t,e){window[t]=e}function nn(t){var e=document.createElement("script");return e.setAttribute("src",t),e.setAttribute("crossorigin","anonymous"),new Promise(function(r){e.addEventListener("load",function(){r()},!1),e.addEventListener("error",function(){r()},!1),document.body.appendChild(e)})}function on(){return c(function(t){switch(t.h){case 1:return t.s=2,F(t,WebAssembly.instantiate(en),4);case 4:t.h=3,t.s=0;break;case 2:return t.s=0,t.l=null,t.return(!1);case 3:return t.return(!0)}})}function be(t){if(this.h=t,this.listeners={},this.l={},this.L={},this.s={},this.v={},this.M=this.u=this.ga=!0,this.I=Promise.resolve(),this.fa="",this.D={},this.locateFile=t&&t.locateFile||rn,typeof window=="object")var e=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if(typeof location<"u")e=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");if(this.ha=e,t.options){e=S(Object.keys(t.options));for(var r=e.next();!r.done;r=e.next()){r=r.value;var n=t.options[r].default;n!==void 0&&(this.l[r]=typeof n=="function"?n():n)}}}w=be.prototype,w.close=function(){return this.j&&this.j.delete(),Promise.resolve()};function sn(t){var e,r,n,i,s,o,a,l,d,h,_;return c(function(k){switch(k.h){case 1:return t.ga?(e=t.h.files===void 0?[]:typeof t.h.files=="function"?t.h.files(t.l):t.h.files,F(k,on(),2)):k.return();case 2:if(r=k.i,typeof window=="object")return yr("createMediapipeSolutionsWasm",{locateFile:t.locateFile}),yr("createMediapipeSolutionsPackedAssets",{locateFile:t.locateFile}),o=e.filter(function(m){return m.data!==void 0}),a=e.filter(function(m){return m.data===void 0}),l=Promise.all(o.map(function(m){var T=Zt(t,m.url);if(m.path!==void 0){var C=m.path;T=T.then(function(z){return t.overrideFile(C,z),Promise.resolve(z)})}return T})),d=Promise.all(a.map(function(m){return m.simd===void 0||m.simd&&r||!m.simd&&!r?nn(t.locateFile(m.url,t.ha)):Promise.resolve()})).then(function(){var m,T,C;return c(function(z){if(z.h==1)return m=window.createMediapipeSolutionsWasm,T=window.createMediapipeSolutionsPackedAssets,C=t,F(z,m(T),2);C.i=z.i,z.h=0})}),h=function(){return c(function(m){return t.h.graph&&t.h.graph.url?m=F(m,Zt(t,t.h.graph.url),0):(m.h=0,m=void 0),m})}(),F(k,Promise.all([d,l,h]),7);if(typeof importScripts!="function")throw Error("solutions can only be loaded on a web page or in a web worker");return n=e.filter(function(m){return m.simd===void 0||m.simd&&r||!m.simd&&!r}).map(function(m){return t.locateFile(m.url,t.ha)}),importScripts.apply(null,et(n)),i=t,F(k,createMediapipeSolutionsWasm(Module),6);case 6:i.i=k.i,t.m=new OffscreenCanvas(1,1),t.i.canvas=t.m,s=t.i.GL.createContext(t.m,{antialias:!1,alpha:!1,va:typeof WebGL2RenderingContext<"u"?2:1}),t.i.GL.makeContextCurrent(s),k.h=4;break;case 7:if(t.m=document.createElement("canvas"),_=t.m.getContext("webgl2",{}),!_&&(_=t.m.getContext("webgl",{}),!_))return alert("Failed to create WebGL canvas context when passing video frame."),k.return();t.K=_,t.i.canvas=t.m,t.i.createContext(t.m,!0,!0,{});case 4:t.j=new t.i.SolutionWasm,t.ga=!1,k.h=0}})}function an(t){var e,r,n,i,s,o,a,l;return c(function(d){if(d.h==1){if(t.h.graph&&t.h.graph.url&&t.fa===t.h.graph.url)return d.return();if(t.u=!0,!t.h.graph||!t.h.graph.url){d.h=2;return}return t.fa=t.h.graph.url,F(d,Zt(t,t.h.graph.url),3)}for(d.h!=2&&(e=d.i,t.j.loadGraph(e)),r=S(Object.keys(t.D)),n=r.next();!n.done;n=r.next())i=n.value,t.j.overrideFile(i,t.D[i]);if(t.D={},t.h.listeners)for(s=S(t.h.listeners),o=s.next();!o.done;o=s.next())a=o.value,fn(t,a);l=t.l,t.l={},t.setOptions(l),d.h=0})}w.reset=function(){var t=this;return c(function(e){t.j&&(t.j.reset(),t.s={},t.v={}),e.h=0})},w.setOptions=function(t,e){var r=this;if(e=e||this.h.options){for(var n=[],i=[],s={},o=S(Object.keys(t)),a=o.next();!a.done;s={X:s.X,Y:s.Y},a=o.next())if(a=a.value,!(a in this.l&&this.l[a]===t[a])){this.l[a]=t[a];var l=e[a];l!==void 0&&(l.onChange&&(s.X=l.onChange,s.Y=t[a],n.push(function(d){return function(){var h;return c(function(_){if(_.h==1)return F(_,d.X(d.Y),2);h=_.i,h===!0&&(r.u=!0),_.h=0})}}(s))),l.graphOptionXref&&(a=Object.assign({},{calculatorName:"",calculatorIndex:0},l.graphOptionXref,{valueNumber:l.type===1?t[a]:0,valueBoolean:l.type===0?t[a]:!1,valueString:l.type===2?t[a]:""}),i.push(a)))}(n.length!==0||i.length!==0)&&(this.u=!0,this.H=(this.H===void 0?[]:this.H).concat(i),this.F=(this.F===void 0?[]:this.F).concat(n))}};function ln(t){var e,r,n,i,s,o,a;return c(function(l){switch(l.h){case 1:if(!t.u)return l.return();if(!t.F){l.h=2;break}e=S(t.F),r=e.next();case 3:if(r.done){l.h=5;break}return n=r.value,F(l,n(),4);case 4:r=e.next(),l.h=3;break;case 5:t.F=void 0;case 2:if(t.H){for(i=new t.i.GraphOptionChangeRequestList,s=S(t.H),o=s.next();!o.done;o=s.next())a=o.value,i.push_back(a);t.j.changeOptions(i),i.delete(),t.H=void 0}t.u=!1,l.h=0}})}w.initialize=function(){var t=this;return c(function(e){return e.h==1?F(e,sn(t),2):e.h!=3?F(e,an(t),3):F(e,ln(t),0)})};function Zt(t,e){var r,n;return c(function(i){return e in t.L?i.return(t.L[e]):(r=t.locateFile(e,""),n=fetch(r).then(function(s){return s.arrayBuffer()}),t.L[e]=n,i.return(n))})}w.overrideFile=function(t,e){this.j?this.j.overrideFile(t,e):this.D[t]=e},w.clearOverriddenFiles=function(){this.D={},this.j&&this.j.clearOverriddenFiles()},w.send=function(t,e){var r=this,n,i,s,o,a,l,d,h,_;return c(function(k){switch(k.h){case 1:return r.h.inputs?(n=1e3*(e??performance.now()),F(k,r.I,2)):k.return();case 2:return F(k,r.initialize(),3);case 3:for(i=new r.i.PacketDataList,s=S(Object.keys(t)),o=s.next();!o.done;o=s.next())if(a=o.value,l=r.h.inputs[a]){t:{var m=t[a];switch(l.type){case"video":var T=r.s[l.stream];if(T||(T=new xe(r.i,r.K),r.s[l.stream]=T),T.m===0&&(T.m=T.i.createTexture()),typeof HTMLVideoElement<"u"&&m instanceof HTMLVideoElement)var C=m.videoWidth,z=m.videoHeight;else typeof HTMLImageElement<"u"&&m instanceof HTMLImageElement?(C=m.naturalWidth,z=m.naturalHeight):(C=m.width,z=m.height);z={glName:T.m,width:C,height:z},C=T.h,C.canvas.width=z.width,C.canvas.height=z.height,C.activeTexture(C.TEXTURE0),T.i.bindTexture2d(T.m),C.texImage2D(C.TEXTURE_2D,0,C.RGBA,C.RGBA,C.UNSIGNED_BYTE,m),T.i.bindTexture2d(0),T=z;break t;case"detections":for(T=r.s[l.stream],T||(T=new tn(r.i),r.s[l.stream]=T),T.data||(T.data=new T.h.DetectionListData),T.data.reset(m.length),z=0;z<m.length;++z){C=m[z];var B=T.data,Q=B.setBoundingBox,lt=z,ot=C.la,M=new Vt;if(ht(M,1,ot.sa),ht(M,2,ot.ta),ht(M,3,ot.height),ht(M,4,ot.width),ht(M,5,ot.rotation),pt(M,6,ot.pa),ot=M.l(),Q.call(B,lt,ot),C.ea)for(B=0;B<C.ea.length;++B){M=C.ea[B],Q=T.data,lt=Q.addNormalizedLandmark,ot=z,M=Object.assign({},M,{visibility:M.visibility?M.visibility:0});var J=new Ht;ht(J,1,M.x),ht(J,2,M.y),ht(J,3,M.z),M.visibility&&ht(J,4,M.visibility),M=J.l(),lt.call(Q,ot,M)}if(C.ba)for(B=0;B<C.ba.length;++B)Q=T.data,lt=Q.addClassification,ot=z,M=C.ba[B],J=new Ot,ht(J,2,M.qa),M.index&&pt(J,1,M.index),M.label&&pt(J,3,M.label),M.displayName&&pt(J,4,M.displayName),M=J.l(),lt.call(Q,ot,M)}T=T.data;break t;default:T={}}}switch(d=T,h=l.stream,l.type){case"video":i.pushTexture2d(Object.assign({},d,{stream:h,timestamp:n}));break;case"detections":_=d,_.stream=h,_.timestamp=n,i.pushDetectionList(_);break;default:throw Error("Unknown input config type: '"+l.type+"'")}}return r.j.send(i),F(k,r.I,4);case 4:i.delete(),k.h=0}})};function un(t,e,r){var n,i,s,o,a,l,d,h,_,k,m,T,C,z;return c(function(B){switch(B.h){case 1:if(!r)return B.return(e);for(n={},i=0,s=S(Object.keys(r)),o=s.next();!o.done;o=s.next())a=o.value,l=r[a],typeof l!="string"&&l.type==="texture"&&e[l.stream]!==void 0&&++i;1<i&&(t.M=!1),d=S(Object.keys(r)),o=d.next();case 2:if(o.done){B.h=4;break}if(h=o.value,_=r[h],typeof _=="string")return C=n,z=h,F(B,cn(t,h,e[_]),14);if(k=e[_.stream],_.type==="detection_list"){if(k){for(var Q=k.getRectList(),lt=k.getLandmarksList(),ot=k.getClassificationsList(),M=[],J=0;J<Q.size();++J){var wt=Zr(Q.get(J)),dn=vt(wt,1),pn=vt(wt,2),hn=vt(wt,3),vn=vt(wt,4),yn=vt(wt,5,0),qt=void 0;qt=qt===void 0?0:qt,wt={la:{sa:dn,ta:pn,height:hn,width:vn,rotation:yn,pa:Yt(ct(wt,6),qt)},ea:ge(lt.get(J)),ba:qr(Kr(ot.get(J)))},M.push(wt)}Q=M}else Q=[];n[h]=Q,B.h=7;break}if(_.type==="proto_list"){if(k){for(Q=Array(k.size()),lt=0;lt<k.size();lt++)Q[lt]=k.get(lt);k.delete()}else Q=[];n[h]=Q,B.h=7;break}if(k===void 0){B.h=3;break}if(_.type==="float_list"){n[h]=k,B.h=7;break}if(_.type==="proto"){n[h]=k,B.h=7;break}if(_.type!=="texture")throw Error("Unknown output config type: '"+_.type+"'");return m=t.v[h],m||(m=new xe(t.i,t.K),t.v[h]=m),F(B,vr(m,k,t.M),13);case 13:T=B.i,n[h]=T;case 7:_.transform&&n[h]&&(n[h]=_.transform(n[h])),B.h=3;break;case 14:C[z]=B.i;case 3:o=d.next(),B.h=2;break;case 4:return B.return(n)}})}function cn(t,e,r){var n;return c(function(i){return typeof r=="number"||r instanceof Uint8Array||r instanceof t.i.Uint8BlobList?i.return(r):r instanceof t.i.Texture2dDataOut?(n=t.v[e],n||(n=new xe(t.i,t.K),t.v[e]=n),i.return(vr(n,r,t.M))):i.return(void 0)})}function fn(t,e){for(var r=e.name||"$",n=[].concat(et(e.wants)),i=new t.i.StringList,s=S(e.wants),o=s.next();!o.done;o=s.next())i.push_back(o.value);s=t.i.PacketListener.implement({onResults:function(a){for(var l={},d=0;d<e.wants.length;++d)l[n[d]]=a.get(d);var h=t.listeners[r];h&&(t.I=un(t,l,e.outs).then(function(_){_=h(_);for(var k=0;k<e.wants.length;++k){var m=l[n[k]];typeof m=="object"&&m.hasOwnProperty&&m.hasOwnProperty("delete")&&m.delete()}_&&(t.I=_)}))}}),t.j.attachMultiListener(i,s),i.delete()}w.onResults=function(t,e){this.listeners[e||"$"]=t},W("Solution",be),W("OptionType",{BOOL:0,NUMBER:1,ua:2,0:"BOOL",1:"NUMBER",2:"STRING"});function mr(t){switch(t===void 0&&(t=0),t){case 1:return"pose_landmark_full.tflite";case 2:return"pose_landmark_heavy.tflite";default:return"pose_landmark_lite.tflite"}}function gr(t){var e=this;t=t||{},this.h=new be({locateFile:t.locateFile,files:function(r){return[{url:"pose_solution_packed_assets_loader.js"},{simd:!1,url:"pose_solution_wasm_bin.js"},{simd:!0,url:"pose_solution_simd_wasm_bin.js"},{data:!0,url:mr(r.modelComplexity)}]},graph:{url:"pose_web.binarypb"},listeners:[{wants:["pose_landmarks","world_landmarks","segmentation_mask","image_transformed"],outs:{image:{type:"texture",stream:"image_transformed"},poseLandmarks:{type:"proto",stream:"pose_landmarks",transform:ge},poseWorldLandmarks:{type:"proto",stream:"world_landmarks",transform:ge},segmentationMask:{type:"texture",stream:"segmentation_mask"}}}],inputs:{image:{type:"video",stream:"input_frames_gpu"}},options:{useCpuInference:{type:0,graphOptionXref:{calculatorType:"InferenceCalculator",fieldName:"use_cpu_inference"},default:typeof window!="object"||window.navigator===void 0?!1:"iPad Simulator;iPhone Simulator;iPod Simulator;iPad;iPhone;iPod".split(";").includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document},selfieMode:{type:0,graphOptionXref:{calculatorType:"GlScalerCalculator",calculatorIndex:1,fieldName:"flip_horizontal"}},modelComplexity:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorModelComplexity",fieldName:"int_value"},onChange:function(r){var n,i,s;return c(function(o){return o.h==1?(n=mr(r),i="third_party/mediapipe/modules/pose_landmark/"+n,F(o,Zt(e.h,n),2)):(s=o.i,e.h.overrideFile(i,s),o.return(!0))})}},smoothLandmarks:{type:0,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorSmoothLandmarks",fieldName:"bool_value"}},enableSegmentation:{type:0,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorEnableSegmentation",fieldName:"bool_value"}},smoothSegmentation:{type:0,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorSmoothSegmentation",fieldName:"bool_value"}},minDetectionConfidence:{type:1,graphOptionXref:{calculatorType:"TensorsToDetectionsCalculator",calculatorName:"poselandmarkgpu__posedetectiongpu__TensorsToDetectionsCalculator",fieldName:"min_score_thresh"}},minTrackingConfidence:{type:1,graphOptionXref:{calculatorType:"ThresholdingCalculator",calculatorName:"poselandmarkgpu__poselandmarkbyroigpu__tensorstoposelandmarksandsegmentation__ThresholdingCalculator",fieldName:"threshold"}}}})}w=gr.prototype,w.reset=function(){this.h.reset()},w.close=function(){return this.h.close(),Promise.resolve()},w.onResults=function(t){this.h.onResults(t)},w.initialize=function(){var t=this;return c(function(e){return F(e,t.h.initialize(),0)})},w.send=function(t,e){var r=this;return c(function(n){return F(n,r.h.send(t,e),0)})},w.setOptions=function(t){this.h.setOptions(t)},W("Pose",gr),W("POSE_CONNECTIONS",[[0,1],[1,2],[2,3],[3,7],[0,4],[4,5],[5,6],[6,8],[9,10],[11,12],[11,13],[13,15],[15,17],[15,19],[15,21],[17,19],[12,14],[14,16],[16,18],[16,20],[16,22],[18,20],[11,23],[12,24],[23,24],[23,25],[24,26],[25,27],[26,28],[27,29],[28,30],[29,31],[30,32],[27,31],[28,32]]),W("POSE_LANDMARKS",{NOSE:0,LEFT_EYE_INNER:1,LEFT_EYE:2,LEFT_EYE_OUTER:3,RIGHT_EYE_INNER:4,RIGHT_EYE:5,RIGHT_EYE_OUTER:6,LEFT_EAR:7,RIGHT_EAR:8,LEFT_RIGHT:9,RIGHT_LEFT:10,LEFT_SHOULDER:11,RIGHT_SHOULDER:12,LEFT_ELBOW:13,RIGHT_ELBOW:14,LEFT_WRIST:15,RIGHT_WRIST:16,LEFT_PINKY:17,RIGHT_PINKY:18,LEFT_INDEX:19,RIGHT_INDEX:20,LEFT_THUMB:21,RIGHT_THUMB:22,LEFT_HIP:23,RIGHT_HIP:24,LEFT_KNEE:25,RIGHT_KNEE:26,LEFT_ANKLE:27,RIGHT_ANKLE:28,LEFT_HEEL:29,RIGHT_HEEL:30,LEFT_FOOT_INDEX:31,RIGHT_FOOT_INDEX:32}),W("POSE_LANDMARKS_LEFT",{LEFT_EYE_INNER:1,LEFT_EYE:2,LEFT_EYE_OUTER:3,LEFT_EAR:7,LEFT_RIGHT:9,LEFT_SHOULDER:11,LEFT_ELBOW:13,LEFT_WRIST:15,LEFT_PINKY:17,LEFT_INDEX:19,LEFT_THUMB:21,LEFT_HIP:23,LEFT_KNEE:25,LEFT_ANKLE:27,LEFT_HEEL:29,LEFT_FOOT_INDEX:31}),W("POSE_LANDMARKS_RIGHT",{RIGHT_EYE_INNER:4,RIGHT_EYE:5,RIGHT_EYE_OUTER:6,RIGHT_EAR:8,RIGHT_LEFT:10,RIGHT_SHOULDER:12,RIGHT_ELBOW:14,RIGHT_WRIST:16,RIGHT_PINKY:18,RIGHT_INDEX:20,RIGHT_THUMB:22,RIGHT_HIP:24,RIGHT_KNEE:26,RIGHT_ANKLE:28,RIGHT_HEEL:30,RIGHT_FOOT_INDEX:32}),W("POSE_LANDMARKS_NEUTRAL",{NOSE:0}),W("VERSION","0.5.1675469404")}).call(xt);var wn={};(function(){function w(u){var c=0;return function(){return c<u.length?{done:!1,value:u[c++]}:{done:!0}}}var y=typeof Object.defineProperties=="function"?Object.defineProperty:function(u,c,O){return u==Array.prototype||u==Object.prototype||(u[c]=O.value),u};function R(u){u=[typeof globalThis=="object"&&globalThis,u,typeof window=="object"&&window,typeof self=="object"&&self,typeof xt=="object"&&xt];for(var c=0;c<u.length;++c){var O=u[c];if(O&&O.Math==Math)return O}throw Error("Cannot find global object")}var L=R(this);function g(u,c){if(c)t:{var O=L;u=u.split(".");for(var E=0;E<u.length-1;E++){var H=u[E];if(!(H in O))break t;O=O[H]}u=u[u.length-1],E=O[u],c=c(E),c!=E&&c!=null&&y(O,u,{configurable:!0,writable:!0,value:c})}}g("Symbol",function(u){function c(W){if(this instanceof c)throw new TypeError("Symbol is not a constructor");return new O(E+(W||"")+"_"+H++,W)}function O(W,p){this.g=W,y(this,"description",{configurable:!0,writable:!0,value:p})}if(u)return u;O.prototype.toString=function(){return this.g};var E="jscomp_symbol_"+(1e9*Math.random()>>>0)+"_",H=0;return c}),g("Symbol.iterator",function(u){if(u)return u;u=Symbol("Symbol.iterator");for(var c="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),O=0;O<c.length;O++){var E=L[c[O]];typeof E=="function"&&typeof E.prototype[u]!="function"&&y(E.prototype,u,{configurable:!0,writable:!0,value:function(){return A(w(this))}})}return u});function A(u){return u={next:u},u[Symbol.iterator]=function(){return this},u}function U(u){var c=typeof Symbol<"u"&&Symbol.iterator&&u[Symbol.iterator];return c?c.call(u):{next:w(u)}}function S(){this.i=!1,this.g=null,this.o=void 0,this.j=1,this.m=0,this.h=null}function et(u){if(u.i)throw new TypeError("Generator is already running");u.i=!0}S.prototype.l=function(u){this.o=u};function D(u,c){u.h={F:c,G:!0},u.j=u.m}S.prototype.return=function(u){this.h={return:u},this.j=this.m};function $(u){this.g=new S,this.h=u}function tt(u,c){et(u.g);var O=u.g.g;return O?X(u,"return"in O?O.return:function(E){return{value:E,done:!0}},c,u.g.return):(u.g.return(c),Y(u))}function X(u,c,O,E){try{var H=c.call(u.g.g,O);if(!(H instanceof Object))throw new TypeError("Iterator result "+H+" is not an object");if(!H.done)return u.g.i=!1,H;var W=H.value}catch(p){return u.g.g=null,D(u.g,p),Y(u)}return u.g.g=null,E.call(u.g,W),Y(u)}function Y(u){for(;u.g.j;)try{var c=u.h(u.g);if(c)return u.g.i=!1,{value:c.value,done:!1}}catch(O){u.g.o=void 0,D(u.g,O)}if(u.g.i=!1,u.g.h){if(c=u.g.h,u.g.h=null,c.G)throw c.F;return{value:c.return,done:!0}}return{value:void 0,done:!0}}function f(u){this.next=function(c){return et(u.g),u.g.g?c=X(u,u.g.g.next,c,u.g.l):(u.g.l(c),c=Y(u)),c},this.throw=function(c){return et(u.g),u.g.g?c=X(u,u.g.g.throw,c,u.g.l):(D(u.g,c),c=Y(u)),c},this.return=function(c){return tt(u,c)},this[Symbol.iterator]=function(){return this}}function x(u){function c(E){return u.next(E)}function O(E){return u.throw(E)}return new Promise(function(E,H){function W(p){p.done?E(p.value):Promise.resolve(p.value).then(c,O).then(W,H)}W(u.next())})}g("Promise",function(u){function c(p){this.h=0,this.i=void 0,this.g=[],this.o=!1;var j=this.j();try{p(j.resolve,j.reject)}catch(P){j.reject(P)}}function O(){this.g=null}function E(p){return p instanceof c?p:new c(function(j){j(p)})}if(u)return u;O.prototype.h=function(p){if(this.g==null){this.g=[];var j=this;this.i(function(){j.l()})}this.g.push(p)};var H=L.setTimeout;O.prototype.i=function(p){H(p,0)},O.prototype.l=function(){for(;this.g&&this.g.length;){var p=this.g;this.g=[];for(var j=0;j<p.length;++j){var P=p[j];p[j]=null;try{P()}catch(G){this.j(G)}}}this.g=null},O.prototype.j=function(p){this.i(function(){throw p})},c.prototype.j=function(){function p(G){return function(st){P||(P=!0,G.call(j,st))}}var j=this,P=!1;return{resolve:p(this.A),reject:p(this.l)}},c.prototype.A=function(p){if(p===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(p instanceof c)this.C(p);else{t:switch(typeof p){case"object":var j=p!=null;break t;case"function":j=!0;break t;default:j=!1}j?this.v(p):this.m(p)}},c.prototype.v=function(p){var j=void 0;try{j=p.then}catch(P){this.l(P);return}typeof j=="function"?this.D(j,p):this.m(p)},c.prototype.l=function(p){this.u(2,p)},c.prototype.m=function(p){this.u(1,p)},c.prototype.u=function(p,j){if(this.h!=0)throw Error("Cannot settle("+p+", "+j+"): Promise already settled in state"+this.h);this.h=p,this.i=j,this.h===2&&this.B(),this.H()},c.prototype.B=function(){var p=this;H(function(){if(p.I()){var j=L.console;typeof j<"u"&&j.error(p.i)}},1)},c.prototype.I=function(){if(this.o)return!1;var p=L.CustomEvent,j=L.Event,P=L.dispatchEvent;return typeof P>"u"?!0:(typeof p=="function"?p=new p("unhandledrejection",{cancelable:!0}):typeof j=="function"?p=new j("unhandledrejection",{cancelable:!0}):(p=L.document.createEvent("CustomEvent"),p.initCustomEvent("unhandledrejection",!1,!0,p)),p.promise=this,p.reason=this.i,P(p))},c.prototype.H=function(){if(this.g!=null){for(var p=0;p<this.g.length;++p)W.h(this.g[p]);this.g=null}};var W=new O;return c.prototype.C=function(p){var j=this.j();p.s(j.resolve,j.reject)},c.prototype.D=function(p,j){var P=this.j();try{p.call(j,P.resolve,P.reject)}catch(G){P.reject(G)}},c.prototype.then=function(p,j){function P(at,ut){return typeof at=="function"?function(_t){try{G(at(_t))}catch(Tt){st(Tt)}}:ut}var G,st,Lt=new c(function(at,ut){G=at,st=ut});return this.s(P(p,G),P(j,st)),Lt},c.prototype.catch=function(p){return this.then(void 0,p)},c.prototype.s=function(p,j){function P(){switch(G.h){case 1:p(G.i);break;case 2:j(G.i);break;default:throw Error("Unexpected state: "+G.h)}}var G=this;this.g==null?W.h(P):this.g.push(P),this.o=!0},c.resolve=E,c.reject=function(p){return new c(function(j,P){P(p)})},c.race=function(p){return new c(function(j,P){for(var G=U(p),st=G.next();!st.done;st=G.next())E(st.value).s(j,P)})},c.all=function(p){var j=U(p),P=j.next();return P.done?E([]):new c(function(G,st){function Lt(_t){return function(Tt){at[_t]=Tt,ut--,ut==0&&G(at)}}var at=[],ut=0;do at.push(void 0),ut++,E(P.value).s(Lt(at.length-1),st),P=j.next();while(!P.done)})},c});var v=typeof Object.assign=="function"?Object.assign:function(u,c){for(var O=1;O<arguments.length;O++){var E=arguments[O];if(E)for(var H in E)Object.prototype.hasOwnProperty.call(E,H)&&(u[H]=E[H])}return u};g("Object.assign",function(u){return u||v});var b=this||self,I={facingMode:"user",width:640,height:480};function N(u,c){this.video=u,this.i=0,this.h=Object.assign(Object.assign({},I),c)}N.prototype.stop=function(){var u=this,c,O,E,H;return x(new f(new $(function(W){if(u.g){for(c=u.g.getTracks(),O=U(c),E=O.next();!E.done;E=O.next())H=E.value,H.stop();u.g=void 0}W.j=0})))},N.prototype.start=function(){var u=this,c;return x(new f(new $(function(O){return navigator.mediaDevices&&navigator.mediaDevices.getUserMedia||alert("No navigator.mediaDevices.getUserMedia exists."),c=u.h,O.return(navigator.mediaDevices.getUserMedia({video:{facingMode:c.facingMode,width:c.width,height:c.height}}).then(function(E){Z(u,E)}).catch(function(E){var H="Failed to acquire camera feed: "+E;throw console.error(H),alert(H),E}))})))};function F(u){window.requestAnimationFrame(function(){bt(u)})}function Z(u,c){u.g=c,u.video.srcObject=c,u.video.onloadedmetadata=function(){u.video.play(),F(u)}}function bt(u){var c=null;u.video.paused||u.video.currentTime===u.i||(u.i=u.video.currentTime,c=u.h.onFrame()),c?c.then(function(){F(u)}):F(u)}var nt=["Camera"],q=b;nt[0]in q||typeof q.execScript>"u"||q.execScript("var "+nt[0]);for(var yt;nt.length&&(yt=nt.shift());)nt.length||N===void 0?q[yt]&&q[yt]!==Object.prototype[yt]?q=q[yt]:q=q[yt]={}:q[yt]=N}).call(xt);var wr={};(function(){function w(f){var x=0;return function(){return x<f.length?{done:!1,value:f[x++]}:{done:!0}}}var y=typeof Object.defineProperties=="function"?Object.defineProperty:function(f,x,v){return f==Array.prototype||f==Object.prototype||(f[x]=v.value),f};function R(f){f=[typeof globalThis=="object"&&globalThis,f,typeof window=="object"&&window,typeof self=="object"&&self,typeof xt=="object"&&xt];for(var x=0;x<f.length;++x){var v=f[x];if(v&&v.Math==Math)return v}throw Error("Cannot find global object")}var L=R(this);function g(f,x){if(x)t:{var v=L;f=f.split(".");for(var b=0;b<f.length-1;b++){var I=f[b];if(!(I in v))break t;v=v[I]}f=f[f.length-1],b=v[f],x=x(b),x!=b&&x!=null&&y(v,f,{configurable:!0,writable:!0,value:x})}}function A(f){var x=typeof Symbol<"u"&&Symbol.iterator&&f[Symbol.iterator];return x?x.call(f):{next:w(f)}}var U=typeof Object.assign=="function"?Object.assign:function(f,x){for(var v=1;v<arguments.length;v++){var b=arguments[v];if(b)for(var I in b)Object.prototype.hasOwnProperty.call(b,I)&&(f[I]=b[I])}return f};g("Object.assign",function(f){return f||U}),g("Array.prototype.fill",function(f){return f||function(x,v,b){var I=this.length||0;for(0>v&&(v=Math.max(0,I+v)),(b==null||b>I)&&(b=I),b=Number(b),0>b&&(b=Math.max(0,I+b)),v=Number(v||0);v<b;v++)this[v]=x;return this}});function S(f){return f||Array.prototype.fill}g("Int8Array.prototype.fill",S),g("Uint8Array.prototype.fill",S),g("Uint8ClampedArray.prototype.fill",S),g("Int16Array.prototype.fill",S),g("Uint16Array.prototype.fill",S),g("Int32Array.prototype.fill",S),g("Uint32Array.prototype.fill",S),g("Float32Array.prototype.fill",S),g("Float64Array.prototype.fill",S);var et=this||self;function D(f,x){f=f.split(".");var v=et;f[0]in v||typeof v.execScript>"u"||v.execScript("var "+f[0]);for(var b;f.length&&(b=f.shift());)f.length||x===void 0?v[b]&&v[b]!==Object.prototype[b]?v=v[b]:v=v[b]={}:v[b]=x}var $={color:"white",lineWidth:4,radius:6,visibilityMin:.5};function tt(f){return f=f||{},Object.assign({},$,{fillColor:f.color},f)}function X(f,x){return f instanceof Function?f(x):f}function Y(f,x,v){return Math.max(Math.min(x,v),Math.min(Math.max(x,v),f))}D("clamp",Y),D("drawLandmarks",function(f,x,v){if(x){v=tt(v),f.save();var b=f.canvas,I=0;x=A(x);for(var N=x.next();!N.done;N=x.next())if(N=N.value,N!==void 0&&(N.visibility===void 0||N.visibility>v.visibilityMin)){f.fillStyle=X(v.fillColor,{index:I,from:N}),f.strokeStyle=X(v.color,{index:I,from:N}),f.lineWidth=X(v.lineWidth,{index:I,from:N});var F=new Path2D;F.arc(N.x*b.width,N.y*b.height,X(v.radius,{index:I,from:N}),0,2*Math.PI),f.fill(F),f.stroke(F),++I}f.restore()}}),D("drawConnectors",function(f,x,v,b){if(x&&v){b=tt(b),f.save();var I=f.canvas,N=0;v=A(v);for(var F=v.next();!F.done;F=v.next()){var Z=F.value;f.beginPath(),F=x[Z[0]],Z=x[Z[1]],F&&Z&&(F.visibility===void 0||F.visibility>b.visibilityMin)&&(Z.visibility===void 0||Z.visibility>b.visibilityMin)&&(f.strokeStyle=X(b.color,{index:N,from:F,to:Z}),f.lineWidth=X(b.lineWidth,{index:N,from:F,to:Z}),f.moveTo(F.x*I.width,F.y*I.height),f.lineTo(Z.x*I.width,Z.y*I.height)),++N,f.stroke()}f.restore()}}),D("drawRectangle",function(f,x,v){v=tt(v),f.save();var b=f.canvas;f.beginPath(),f.lineWidth=X(v.lineWidth,{}),f.strokeStyle=X(v.color,{}),f.fillStyle=X(v.fillColor,{}),f.translate(x.xCenter*b.width,x.yCenter*b.height),f.rotate(x.rotation*Math.PI/180),f.rect(-x.width/2*b.width,-x.height/2*b.height,x.width*b.width,x.height*b.height),f.translate(-x.xCenter*b.width,-x.yCenter*b.height),f.stroke(),f.fill(),f.restore()}),D("lerp",function(f,x,v,b,I){return Y(b*(1-(f-x)/(v-x))+I*(1-(v-f)/(v-x)),b,I)})}).call(xt);class kn{constructor(y,R,L){gt(this,"pose");gt(this,"camera",null);gt(this,"videoElement");gt(this,"canvasElement");gt(this,"canvasCtx");gt(this,"audioContext",null);gt(this,"onFocusChange");this.videoElement=y,this.canvasElement=R,this.canvasCtx=R.getContext("2d"),this.onFocusChange=L,this.pose=new br.Pose({locateFile:g=>`https://cdn.jsdelivr.net/npm/@mediapipe/pose/${g}`}),this.pose.setOptions({modelComplexity:1,smoothLandmarks:!0,enableSegmentation:!1,smoothSegmentation:!0,minDetectionConfidence:.5,minTrackingConfidence:.5}),this.pose.onResults(g=>this.processResults(g)),window.addEventListener("resize",()=>this.syncCanvasSize()),this.camera=new wn.Camera(y,{onFrame:async()=>{await this.pose.send({image:y})},width:640,height:480})}syncCanvasSize(){this.videoElement.videoWidth&&(this.canvasElement.width=this.videoElement.clientWidth,this.canvasElement.height=this.videoElement.clientHeight)}start(){var y;this.initSilentAudio(),(y=this.camera)==null||y.start()}initSilentAudio(){if(this.audioContext)this.audioContext.state==="suspended"&&this.audioContext.resume();else{this.audioContext=new(window.AudioContext||window.webkitAudioContext);const y=this.audioContext.createOscillator(),R=this.audioContext.createGain();R.gain.value=.001,y.connect(R),R.connect(this.audioContext.destination),y.start()}}stop(){var y;(y=this.camera)==null||y.stop()}processResults(y){if(this.syncCanvasSize(),this.canvasCtx.save(),this.canvasCtx.clearRect(0,0,this.canvasElement.width,this.canvasElement.height),this.canvasCtx.scale(-1,1),this.canvasCtx.translate(-this.canvasElement.width,0),y.poseLandmarks&&(wr.drawConnectors(this.canvasCtx,y.poseLandmarks,br.POSE_CONNECTIONS,{color:"#13EC80",lineWidth:4}),wr.drawLandmarks(this.canvasCtx,y.poseLandmarks,{color:"#FFFFFF",lineWidth:1,radius:3})),this.canvasCtx.restore(),!y.poseLandmarks){this.onFocusChange(!1);return}const R=y.poseLandmarks[7],L=y.poseLandmarks[8],g=y.poseLandmarks[11],A=y.poseLandmarks[12];if(!R||!L||!g||!A){this.onFocusChange(!1);return}const U=(g.y+A.y)/2,et=(R.y+L.y)/2<U&&Math.abs(R.x-L.x)>.03;this.onFocusChange(et)}}const En=w=>{var b,I;w.innerHTML=`
  ...
  `;const y=w.querySelector("#webcam"),R=w.querySelector("#pose-canvas"),L=w.querySelector("#pause-overlay"),g=w.querySelector("#warning-badge"),A=w.querySelector("#time-count"),U=w.querySelector("#stai-score"),S=w.querySelector("#progress-circle"),et=w.querySelector("#focus-progress-bar"),D=w.querySelector("#focus-level-text");let $=0,tt=null;const X=816,Y=()=>{R.width=y.clientWidth,R.height=y.clientHeight};y.onloadedmetadata=Y,window.addEventListener("resize",Y);const f=new kn(y,R,N=>{N?(L.style.opacity="0",L.style.pointerEvents="none",g.style.opacity="0",D.textContent="최상",D.classList.replace("text-red-500","text-primary"),tt||x()):(L.style.opacity="1",L.style.pointerEvents="auto",g.style.opacity="1",D.textContent="경고",D.classList.replace("text-primary","text-red-500"),v())}),x=()=>{tt=setInterval(()=>{$++;const N=Math.floor($/60).toString().padStart(2,"0"),F=($%60).toString().padStart(2,"0");A.textContent=`${N}:${F}`;const Z=$%3600/3600,bt=X-Z*X;S.style.strokeDashoffset=bt.toString();const nt=80+Math.floor(Math.random()*20);U.textContent=nt.toString(),et.style.width=`${nt}%`},1e3)},v=()=>{clearInterval(tt),tt=null};(b=w.querySelector("#start-btn"))==null||b.addEventListener("click",()=>{f.start(),w.querySelector("#start-btn").style.opacity="0.5",w.querySelector("#start-btn").disabled=!0,w.querySelector("#start-btn").innerText="몰입 중..."}),(I=w.querySelector("#stop-btn"))==null||I.addEventListener("click",async()=>{var bt;f.stop(),v();const{saveSession:N,auth:F}=await we(async()=>{const{saveSession:nt,auth:q}=await import("./firebase-D3Pd4SDz.js");return{saveSession:nt,auth:q}},__vite__mapDeps([0,1]),import.meta.url),Z=((bt=F.currentUser)==null?void 0:bt.uid)||"guest_user";await N(Z,$,parseInt(U.textContent||"0")),alert(`고생하셨습니다! 총 ${$}초 동안 몰입하셨습니다.`),window.location.hash="#/leaderboard"})},An=w=>{w.innerHTML=`
      ...
      <div id="leaderboard-list" class="flex flex-col gap-2 px-4 py-2 flex-grow overflow-y-auto hide-scrollbar">
        ...
        ${[1,2,3,4,5].map(y=>`
          <div class="flex items-center gap-4 bg-white dark:bg-slate-800/40 p-4 rounded-xl border border-primary/5 shadow-sm">
            <div class="text-slate-400 dark:text-slate-500 font-bold w-6 text-sm">${115+y}</div>
            <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-12 w-12 border-2 border-slate-200 dark:border-primary/20"
              style="background-image: url('https://api.dicebear.com/7.x/avataaars/svg?seed=User${y}')">
            </div>
            <div class="flex flex-col flex-1">
              <p class="text-slate-900 dark:text-slate-100 text-base font-bold">User ${y}</p>
              <div class="flex items-center gap-1">
                <span class="size-2 rounded-full ${y%2===0?"bg-primary animate-pulse":"bg-slate-300"}"></span>
                <p class="${y%2===0?"text-primary":"text-slate-500"} text-xs">${y%2===0?"현재 몰입 중":"2시간 전"}</p>
              </div>
            </div>
            <div class="text-right">
              <p class="text-primary text-sm font-bold">${150-y*5}</p>
            ...
            <div class="flex flex-col items-center gap-2">
              <div class="relative w-20 h-20 rounded-full border-2 border-primary/40 p-1">
                <div class="w-full h-full rounded-full bg-cover bg-center grayscale opacity-80 overflow-hidden"
                  style="background-image: url('https://api.dicebear.com/7.x/avataaars/svg?seed=Rival${y}')">
                </div>
              </div>
              <p class="text-xs font-medium opacity-60">Rival ${y}</p>
            </div>
          `).join("")}
  ...
  `},Tn=(w,y)=>{const R=window.paypal;if(!R){console.error("PayPal SDK not loaded");return}R.Buttons({createOrder:(L,g)=>g.order.create({purchase_units:[{amount:{value:y}}]}),onApprove:async(L,g)=>{const A=await g.order.capture();console.log("Payment Approved:",A)}}).render(`#${w}`)},Sn=w=>{w.innerHTML=`
  ...
  `,setTimeout(()=>{Tn("paypal-button-container","12000")},300)};class On{constructor(){gt(this,"appElement");this.appElement=document.querySelector("#app"),window.addEventListener("hashchange",()=>this.handleRoute()),this.initApp()}async initApp(){const{auth:y}=await we(async()=>{const{auth:L}=await import("./firebase-D3Pd4SDz.js");return{auth:L}},__vite__mapDeps([0,1]),import.meta.url),{signInAnonymously:R}=await we(async()=>{const{signInAnonymously:L}=await import("./index.esm-B9-atSTT.js").then(g=>g.k);return{signInAnonymously:L}},[],import.meta.url);await R(y).catch(console.error),document.body.addEventListener("click",L=>{var A;const g=L.target.closest("a");g&&((A=g.getAttribute("href"))!=null&&A.startsWith("#/"))}),(!window.location.hash||window.location.hash==="#")&&(window.location.hash="#/"),this.handleRoute()}handleRoute(){const R=(window.location.hash||"#/").replace(/^#/,"");switch(window.scrollTo(0,0),this.appElement.innerHTML="",R){case"/":En(this.appElement);break;case"/leaderboard":An(this.appElement);break;case"/study-room":jn(this.appElement);break;case"/profile":_n(this.appElement);break;case"/subscription":Sn(this.appElement);break;default:window.location.hash="#/";return}this.updateNavStatus(R)}updateNavStatus(y){document.querySelectorAll("a[href]").forEach(L=>{const g=L.getAttribute("href");if(g===`#${y}`||y==="/"&&g==="#/"){L.classList.add("text-primary"),L.classList.remove("text-slate-400","text-slate-500");const U=L.querySelector(".material-symbols-outlined");U&&U.classList.add("font-variation-fill")}else{L.classList.remove("text-primary"),L.classList.add("text-slate-400");const U=L.querySelector(".material-symbols-outlined");U&&U.classList.remove("font-variation-fill")}})}navigateTo(y){window.location.hash=`#${y}`}}new On;
