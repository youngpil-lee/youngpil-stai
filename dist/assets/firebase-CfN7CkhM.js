 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new gt(O.comparator);function Rn(){return Xa}const xs=new gt(O.comparator);function pn(...r){let t=xs;for(const e of r)t=t.insert(e.key,e);return t}function Ms(r){let t=xs;return r.forEach((e,i)=>t=t.insert(e,i.overlayedDocument)),t}function $t(){return ke()}function Ls(){return ke()}function ke(){return new le(r=>r.toString(),(r,t)=>r.isEqual(t))}const Ya=new gt(O.comparator),Ja=new ft(O.comparator);function ct(...r){let t=Ja;for(const e of r)t=t.add(e);return t}const Za=new ft(B);function tl(){return Za}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cr(r,t){if(r.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vn(t)?"-0":t}}function Fs(r){return{integerValue:""+r}}function el(r,t){return Sa(t)?Fs(t):Cr(r,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kn{constructor(){this._=void 0}}function nl(r,t,e){return r instanceof Le?function(s,a){const u={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return a&&wr(a)&&(a=Rs(a)),a&&(u.fields.__previous_value__=a),{mapValue:u}}(e,t):r instanceof Fe?Bs(r,t):r instanceof Ue?js(r,t):function(s,a){const u=Us(s,a),c=Xi(u)+Xi(s.Pe);return mr(u)&&mr(s.Pe)?Fs(c):Cr(s.serializer,c)}(r,t)}function rl(r,t,e){return r instanceof Fe?Bs(r,t):r instanceof Ue?js(r,t):e}function Us(r,t){return r instanceof Pn?function(i){return mr(i)||function(a){return!!a&&"doubleValue"in a}(i)}(t)?t:{integerValue:0}:null}class Le extends kn{}class Fe extends kn{constructor(t){super(),this.elements=t}}function Bs(r,t){const e=qs(t);for(const i of r.elements)e.some(s=>It(s,i))||e.push(i);return{arrayValue:{values:e}}}class Ue extends kn{constructor(t){super(),this.elements=t}}function js(r,t){let e=qs(t);for(const i of r.elements)e=e.filter(s=>!It(s,i));return{arrayValue:{values:e}}}class Pn extends kn{constructor(t,e){super(),this.serializer=t,this.Pe=e}}function Xi(r){return nt(r.integerValue||r.doubleValue)}function qs(r){return Rr(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(t){this.Mr=t,this.docs=function(){return new gt(O.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const i=e.key,s=this.docs.get(i),a=s?s.size:0,u=this.Mr(e);return this.docs=this.docs.insert(i,{document:e.mutableCopy(),size:u}),this.size+=u-a,this.indexManager.addToCollectionParentIndex(t,i.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const i=this.docs.get(e);return R.resolve(i?i.document.mutableCopy():Et.newInvalidDocument(e))}getEntries(t,e){let i=Rn();return e.forEach(s=>{const a=this.docs.get(s);i=i.insert(s,a?a.document.mutableCopy():Et.newInvalidDocument(s))}),R.resolve(i)}getDocumentsMatchingQuery(t,e,i,s){let a=Rn();const u=e.path,c=new O(u.child("")),f=this.docs.getIteratorFrom(c);for(;f.hasNext();){const{key:_,value:{document:A}}=f.getNext();if(!u.isPrefixOf(_.path))break;_.path.length>u.length+1||wa(Ia(A),i)<=0||(s.has(A.key)||Sr(e,A))&&(a=a.insert(A.key,A.mutableCopy()))}return R.resolve(a)}getAllFromCollectionGroup(t,e,i,s){M()}Or(t,e){return R.forEach(this.docs,i=>e(i))}newChangeBuffer(t){return new Fl(this)}getSize(t){return R.resolve(this.size)}}class Fl extends Dl{constructor(t){super(),this.cr=t}applyChanges(t){const e=[];return this.changes.forEach((i,s)=>{s.isValidDocument()?e.push(this.cr.addEntry(t,s)):this.cr.removeEntry(i)}),R.waitFor(e)}getFromCache(t,e){return this.cr.getEntry(t,e)}getAllFromCache(t,e){return this.cr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
